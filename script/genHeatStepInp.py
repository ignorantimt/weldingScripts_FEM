...
with open(path2txt, "w") as file:
    ...
    ut.createSurfFilm(file,'SURF-1',0.02,20)
    file.write("**\n")
    ...
    ut.createHeatTransStep(file, num_steps+num_steps_end+2, 1, 2400, 120)
    ut.endStep(file)
    ut.createHeatTransStep(file, num_steps+num_steps_end+3, 1, 1, 1)
    ut.endStep(file)
